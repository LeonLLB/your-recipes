...
const LoginPage = () => {	
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mx-5 p-2 place-items-center">
      ...
      <div id="login-container" className='flex flex-col space-y-2 w-3/5 md:w-72 xl:w-3/5'>
				...
				<SimpleFormInput Icon={Lock} Type='password' Name='password' Label='Password' onInputChange={onInputChange} value={form.password} classNameField='w-full' classNameContentLabel='!left-1'/>
